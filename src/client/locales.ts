...
export const en = {
  ...
  contextCardIntro: 'Choose the context budget DSH uses for GPT-6 Astra and GPT-5.6 Sol, Terra, and Luna.',
  contextStandardBadge: '272K standard',
  contextLongBadge: '1M enabled',
  enableLongContext: 'Enable 1M context',
  contextBehavior: 'When enabled, DSH reports a 1,000,000-token context window and delays automatic compaction for GPT-6 Astra and supported GPT-5.6 models.',
  ...
  xhigh: 'Extra high',
  maxQuality: 'Maximum',
  imageSizeHint: 'auto or WIDTHxHEIGHT. GPT Image 2.5 supports custom sizes; above 2560×1440 is experimental. Actual dimensions depend on the backend. Saved on Enter or when leaving the field.',
  invalidImageSize: 'Choose a preset or a GPT Image 2.5 size: multiples of 16, aspect ratio 1:3–3:1, edges up to 3840, and 655,360–8,294,400 pixels.',
  invalidImageQuality: 'Extra high and Maximum quality require GPT Image 2.5. Choose a supported quality for this model.',
...
export const zh: Record<CodexAuthKey, string> = {
  ...
  contextCardIntro: '设置 DSH 为 GPT-6 Astra 以及 GPT-5.6 Sol、Terra 和 Luna 使用的上下文预算。',
  contextStandardBadge: '标准 272K',
  contextLongBadge: '已启用 1M',
  enableLongContext: '启用 1M 上下文',
  contextBehavior: '启用后，DSH 会为 GPT-6 Astra 和支持的 GPT-5.6 模型报告 1,000,000 Token 上下文，并延后自动压缩。',
  ...
  xhigh: '超高',
  maxQuality: '最高',
  imageSizeHint: '填写 auto 或 宽x高。GPT Image 2.5 支持自定义尺寸；超过 2560×1440 为实验性分辨率。实际尺寸以后端返回为准。按回车或离开输入框时保存。',
  invalidImageSize: '请选择预设尺寸，或使用 GPT Image 2.5 自定义尺寸：16 的倍数，宽高比 1:3～3:1，单边不超过 3840，总像素 655,360～8,294,400。',
  invalidImageQuality: '超高与最高质量需要 GPT Image 2.5，请为当前模型选择受支持的质量。',
  enableImage: '启用图片创作',
